...
public class DoiMatKhauDialogCopy extends JDialog {
    ...
    public DoiMatKhauDialogCopy(AdminFrame adminFrame) {
        this.adminFrame = adminFrame;
        this.currentUser = this.adminFrame.getCurrentUser();
        initComponents();
    }

    public DoiMatKhauDialogCopy(StaffFrame staffFrame) {
        this.staffFrame = staffFrame;
        this.currentUser = this.staffFrame.getCurrentUser();
        initComponents();
    }
