...
public class TaiKhoanDialog extends JDialog {
	...
	private void textFieldInit(){
		...
		{
			JLabel lblMatKhauConfirm = new JLabel("Mật khẩu xác nhận");
	...
	public void showEdit(int idTK) {
		...
		txtMatKhauConfirm.setText(taiKhoan.getMatkhau());
	...
	private boolean isError() {
		...
		JLabel[] errors = {errTenTK, errMatKhau, errMatKhauConfirm, errEmail};
