...
public class ThongKePanel extends JPanel {
	...
	public ThongKePanel() {
		...
		comboFilterOption.setBackground(new Color(255, 255, 255));
		...
		btnXemLoiNhuan.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btnXemLoiNhuan.setBackground(new Color(60, 179, 113));
		...
		btnXemNhapKho.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btnXemNhapKho.setBackground(new Color(255, 105, 180));
		...
		btnXemSanPham.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btnXemSanPham.setBackground(new Color(30, 144, 255));
		...
		tableThongKeScrollPane.getViewport().setBackground(new Color(255, 240, 220)); // đổi màu nền
//		tableThongKeScrollPane.setBorder(null); // nếu muốn bỏ viền xám
