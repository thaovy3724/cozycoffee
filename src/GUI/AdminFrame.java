	...
	public void toggleBtnInit(JToggleButton btn) {
		...
		btn.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                replaceDynamicPanel(e.getStateChange() == ItemEvent.SELECTED);
            }
        });
	}
	
	private void replaceDynamicPanel(boolean isSelected) {
        dynamicPanel.removeAll();
        JPanel selectedPanel = new DanhMucPanel();
        if (isSelected) {
